<div class="container" style="padding:10;">
	...
	<!-- Product Form -->
	<div class="row">
		<form class="col s12" action="<?php echo base_url(); ?>Product/register" method="post" style="padding: 50px; margin-top:150px;" enctype="multipart/form-data">
			...
			<div class="row">
				...
				<input class="btn btn-success" name="register" type="submit" class="btn btn-register" style="margin-top: 50px" value="Confirm" />
			</div>
